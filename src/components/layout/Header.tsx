...
export function Header() {
  ...
  const shouldShowSearch = pathname === '/events' || pathname === '/my-events' || pathname.startsWith('/events/');
      ...
      <div className="container mx-auto px-4 h-16 flex items-center justify-between">
        ...
        <div className="flex items-center">
          <Link href="/" className="flex items-center">
            <div className="h-10 w-10 rounded-full bg-gradient-to-r from-blue-600 to-purple-600 flex items-center justify-center text-lg font-bold text-white mr-2">
              EV
            </div>
            <span className="text-lg font-bold text-gray-900 hidden md:block">TechEventos</span>
          </Link>
        </div>
      </div>
    </header>
